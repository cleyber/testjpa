...
public class TestEmployees{
   ...
   public static void main(String[] args){
      ...
      Employee employee = new Employee(2L, "Cleyber", "Rengifo f.", LocalDate.of(1994, 12, 30));
      // Employee employee2 = new Employee(3L, "Dubian", "Rengifo f.", DateParser.parseDate("1994-12-30"));
      // Employee employee3 = new Employee(4L, "Example", "Example Example", DateParser.parseDate("2000-10-05"));
